...
public class QueryMaster {
    ...
    public String buildQuery(String sql, RolesPrivilegesMap rolesPrivilegesMap, String tableName) throws Exception {
        String safeSql = queryBuilder.returnPreparedSQL(rolesPrivilegesMap.getFilteredList(), sql, tableName);
